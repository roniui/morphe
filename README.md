# Morphe apks builder
[![Latest Version](https://img.shields.io/github/v/release/roniui/morphe?style=flat-square&color=blue&label=Release)](https://github.com/roniui/morphe/releases/latest)
...
Get the [latest CI release](https://github.com/roniui/morphe/releases).
 ...
 * Star the repo :eyes:
 * Use the repo as a [template](https://github.com/new?template_name=morphe&template_owner=roniui)
